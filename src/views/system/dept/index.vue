    ...
    <el-card>
      ...
      <el-table :data="tableData" border stripe v-loading="loading">
        ...
        <el-table-column label="操作" min-width="180" fixed="right">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" v-perm="'system:dept:update'" @click="handleEdit(scope.row)">编辑</el-button>
            <el-button size="mini" type="danger" v-perm="'system:dept:delete'" @click="handleDelete(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
